...
# Ex1.: 
#   Criar uma classe Tenis
#       Construtor com parâmetros: modelo, tamanho 
#       Criar função para apresentar os dados
# Instanciar 3 objetos do tenis, preencher o modelo e tamanho
# Chamar o apresentar os dados
# Adicionar no construtor parâmetro: marca, valor
# Modificar os 3 tenis para definir a marca e valor no construtor
